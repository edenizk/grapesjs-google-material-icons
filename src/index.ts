...
const plugin: grapesjs.Plugin = (editor: grapesjs.Editor, opts = {}) => {
  ...
  editor.BlockManager.add('SideContentItem', {
    label: 'Side Content Item',
    ...
    content: `<span class="material-icons material-symbols-outlined">home</span>`,
  });


  IconPickerPopup(editor);
};
